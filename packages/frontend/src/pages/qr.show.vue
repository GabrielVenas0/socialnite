...
<div :class="$style.root">
	<div :class="[$style.content]">
		...
		<img v-if="deviceMotionPermissionNeeded" v-flip :class="$style.logo" :src="logoImg" alt="Social Nite Logo" @click="requestDeviceMotion"/>
		<img v-else v-flip :class="$style.logo" :src="logoImg" alt="Social Nite Logo"/>
	</div>
</div>
</template>
