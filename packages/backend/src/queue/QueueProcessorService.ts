...
import { CleanExpiredStoriesProcessorService } from './processors/CleanExpiredStoriesProcessorService.js';
...
export class QueueProcessorService implements OnApplicationShutdown {
	...
	constructor(
		...
		private cleanExpiredStoriesProcessorService: CleanExpiredStoriesProcessorService,
		...
		//#region system
		{
			const processer = (job: Bull.Job) => {
				switch (job.name) {
					...
					case 'cleanExpiredStories': return this.cleanExpiredStoriesProcessorService.process();
